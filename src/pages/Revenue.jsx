        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-5 md:p-8 animate-fade-in mb-8">
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                    <div className="bg-slate-50/50 p-6 rounded-2xl border border-slate-100 transition-all group">
                        <div className="flex justify-between items-start mb-4">
                            <div className="p-3 bg-blue-100/50 rounded-xl text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                                <DollarSign className="w-5 h-5 md:w-6 md:h-6" />
                            </div>
                            <span className="text-[10px] font-bold text-emerald-600 bg-white px-2 py-1 rounded-lg border border-emerald-100 shadow-sm">+18.2%</span>
                        </div>
                    ...
                    <div className="bg-slate-50/50 p-6 rounded-2xl border border-slate-100 transition-all group">
                        <div className="flex justify-between items-start mb-4">
                            <div className="p-3 bg-emerald-100/50 rounded-xl text-emerald-600 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                                <CreditCard className="w-5 h-5 md:w-6 md:h-6" />
                            </div>
                            <span className="text-[10px] font-bold text-emerald-600 bg-white px-2 py-1 rounded-lg border border-emerald-100 shadow-sm">+5.4%</span>
                        </div>
                    ...
                    <div className="bg-slate-50/50 p-6 rounded-2xl border border-slate-100 transition-all group">
                        <div className="flex justify-between items-start mb-4">
                            <div className="p-3 bg-rose-100/50 rounded-xl text-rose-600 group-hover:bg-rose-600 group-hover:text-white transition-colors">
                                <PieIcon className="w-5 h-5 md:w-6 md:h-6" />
                            </div>
                            <span className="text-[10px] font-bold text-emerald-600 bg-white px-2 py-1 rounded-lg border border-emerald-100 shadow-sm">-2.1%</span>
                        </div>
                ...
                <section className="bg-slate-50/50 p-6 md:p-8 rounded-2xl border border-slate-100 flex flex-col h-auto">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h2 className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">Revenue Analysis</h2>
                            <p className="text-[11px] text-slate-400 mt-0.5 px-1">Accumulated revenue vs targets.</p>
                        </div>
                        <button className="flex items-center space-x-2 px-3 py-1.5 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-50 transition-all active:scale-95 shadow-sm">
                ...
                <section className="space-y-4">
                    <h2 className="text-xs font-bold text-slate-400 uppercase tracking-[0.2em] px-1">Financial Ledger</h2>
                    <Table
                        columns={columns}
                        ...
                        renderMobileRow={(entry) => (
                            <div className="bg-slate-50/50 p-5 rounded-2xl border border-slate-100 mb-4 last:mb-0">
                                ...
                                <div className="grid grid-cols-2 gap-y-3 pt-4 border-t border-slate-200/60">
                                    <div>
